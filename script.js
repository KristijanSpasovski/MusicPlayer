...
const allSongs = [
  ...
  },
  {
    ...
    artist: "ENheee",
    duration: "3:47",
    src: "assets/songs/ENheeeHipHopBeat.mp3",
  },
  {
    id: 2,
    title: "Goldn",
  ...
  },
  {
    ...
    artist: "Alex Grohl",
    duration: "1:56",
    src: "assets/songs/SadSoulAlexGrohl.mp3",
  },
  {
    id: 6,
    title: "Money",
    artist: "Soul Music",
    duration: "2:06",
    src: "assets/songs/SoulProdMusicMoney.mp3",
  },
];
...
const renderSongs = (array) => {
  ...
  <button class="playlist-song-delete" aria-label="Delete ${song.title}"> <button onclick="deleteSong(${song.id})" class="playlist-song-delete" aria-label="Delete ${song.title}">   <svg width="20" height="20" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="8" cy="8" r="8" fill="#4d4d62"/>
