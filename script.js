...
const renderSongs = (array) => {
  ...
  <button class="playlist-song-delete" aria-label="Delete ${song.title}"> <button class="playlist-song-delete" aria-label="Delete ${song.title}">   <svg width="20" height="20" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="8" cy="8" r="8" fill="#4d4d62"/>
